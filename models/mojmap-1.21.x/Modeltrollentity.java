...
public class Modeltrollentity<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "trollentity"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition top = partdefinition.addOrReplaceChild("top", CubeListBuilder.create().texOffs(0, 52)
				.addBox(-5.0F, -12.0F, -2.0F, 10.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)),
