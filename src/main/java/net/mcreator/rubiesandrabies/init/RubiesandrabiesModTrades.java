...
public class RubiesandrabiesModTrades {
	...
	public static void registerTrades(VillagerTradesEvent event) {
		if (event.getType() == ResourceKey.create(Registries.VILLAGER_PROFESSION, ResourceLocation.parse("rubiesandrabies:ruby_trader"))) {
			...
			event.getTrades().get(1).add(new BasicItemListing(new ItemStack(RubiesandrabiesModItems.RUBY.get(), 4), new ItemStack(Items.QUARTZ, 64), 10, 5, 0.05f));
			...
			event.getTrades().get(1).add(new BasicItemListing(new ItemStack(RubiesandrabiesModItems.RUBY.get(), 8), new ItemStack(Items.DIAMOND_PICKAXE), 10, 5, 0.05f));
			event.getTrades().get(1).add(new BasicItemListing(new ItemStack(RubiesandrabiesModItems.RUBY.get(), 20), new ItemStack(Items.PAPER, 5), new ItemStack(RubiesandrabiesModItems.PAGE_OF_EVIL.get()), 1, 5, 1f));
		}
	}
}