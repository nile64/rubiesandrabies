...
public class RubiesandrabiesModMenus {
	...
	public static final DeferredHolder<MenuType<?>, MenuType<HumanMenuMenu>> HUMAN_MENU = REGISTRY.register("human_menu", () -> IMenuTypeExtension.create(HumanMenuMenu::new));
