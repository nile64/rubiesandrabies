...
public class EvilMachineBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public EvilMachineBlockEntity(BlockPos position, BlockState state) {
		super(RubiesandrabiesModBlockEntities.EVIL_MACHINE.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("evil_machine");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Evil Machine");
	}
