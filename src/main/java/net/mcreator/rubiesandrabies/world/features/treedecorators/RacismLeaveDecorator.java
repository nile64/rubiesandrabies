...
@EventBusSubscriber
public class RacismLeaveDecorator extends LeaveVineDecorator {
	public static MapCodec<RacismLeaveDecorator> CODEC = MapCodec.unit(RacismLeaveDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("rubiesandrabies:racism_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public RacismLeaveDecorator() {
		super(0.25f);
	}
