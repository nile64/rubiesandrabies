...
@EventBusSubscriber
public class AbyssBiomeTrunkDecorator extends TrunkVineDecorator {
	public static MapCodec<AbyssBiomeTrunkDecorator> CODEC = MapCodec.unit(AbyssBiomeTrunkDecorator::new);
	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("rubiesandrabies:abyss_biome_tree_trunk_decorator"), () -> DECORATOR_TYPE);
	}
