...
@EventBusSubscriber
public class NetherRacismFruitDecorator extends CocoaDecorator {

	public static MapCodec<NetherRacismFruitDecorator> CODEC = MapCodec.unit(NetherRacismFruitDecorator::new);

	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("rubiesandrabies:nether_racism_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public NetherRacismFruitDecorator() {
		super(0.2f);
	}
