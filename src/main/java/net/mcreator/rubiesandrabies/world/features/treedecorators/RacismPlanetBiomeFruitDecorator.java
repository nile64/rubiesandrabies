...
@EventBusSubscriber
public class RacismPlanetBiomeFruitDecorator extends CocoaDecorator {

	public static MapCodec<RacismPlanetBiomeFruitDecorator> CODEC = MapCodec.unit(RacismPlanetBiomeFruitDecorator::new);

	public static TreeDecoratorType<?> DECORATOR_TYPE = new TreeDecoratorType<>(CODEC);

	@SubscribeEvent
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("rubiesandrabies:racism_planet_biome_tree_fruit_decorator"), () -> DECORATOR_TYPE);
	}

	public RacismPlanetBiomeFruitDecorator() {
		super(0.2f);
	}
