...
public class NetherRacismLeaveDecorator extends LeaveVineDecorator {
	...
	public static void registerTreeDecorator(RegisterEvent event) {
		event.register(Registries.TREE_DECORATOR_TYPE, ResourceLocation.parse("rubiesandrabies:nether_racism_tree_leave_decorator"), () -> DECORATOR_TYPE);
	}

	public NetherRacismLeaveDecorator() {
		super(0.25f);
	}
