...
public class GorillaEntity extends Animal {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(4, new TemptGoal(this, 1, Ingredient.of(RubiesandrabiesModItems.DELETED_MOD_ELEMENT.get()), false));
	...
	public boolean isFood(ItemStack stack) {
		return Ingredient.of(RubiesandrabiesModItems.DELETED_MOD_ELEMENT.get()).test(stack);
	}
