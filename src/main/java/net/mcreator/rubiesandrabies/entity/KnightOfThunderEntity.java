...
import net.mcreator.rubiesandrabies.procedures.KnightOfThunderOnInitialEntitySpawnProcedure;
...
public class KnightOfThunderEntity extends Monster {
	...
	public SoundEvent getDeathSound() {
		return BuiltInRegistries.SOUND_EVENT.getValue(ResourceLocation.parse("rubiesandrabies:thunderdeath"));
	}
